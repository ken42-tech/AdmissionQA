...
public class ActionXpath {
    ...
    static String clickonanyImpInformation = "//div[@aria-haspopup='listbox']";
    ...
    static String selecttrainning = "(//div[.='Lucknow University, Lucknow'])[1]";
    ...
    static String selecrole = "//li[.='Yes']";
