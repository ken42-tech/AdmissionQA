...
public class ltpct {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (Utils.checkWindowsOs()) {
            CSV_PATH = "C:\\Users\\Public\\Documents\\jalnagar.csv";
    ...
    public static void testValidatefirstname(String url, WebDriver Driver, String[] csvCell) throws Exception {
        try {
            ...
            Utils.callSendkeys(driver, ActionXpath.firstname, checkwithalphabet, "checkwithalphabet");
    ...
    public static void testValidatelastname(String url, WebDriver Driver, String[] csvCell) throws Exception {
        try {
            ...
            Utils.callSendkeys(driver, ActionXpath.lastName, checkwithalphabet, "checkwithalphabet");
    ...
    public static void testValidatemiddlename(String url, WebDriver Driver, String[] csvCell) throws Exception {
        ...
        try {
            ...
            Utils.callSendkeys(driver, ActionXpath.middlename, checkwithalphabet, "check alphabet");

            Utils.cleartext(driver, ActionXpath.middlename);

            Utils.callSendkeys(driver, ActionXpath.middlename, checkwithnumber, "check no");
            // WebElement alphamiddlename =
            ...
            // }
            Utils.cleartext(driver, ActionXpath.middlename);
            Utils.callSendkeys(driver, ActionXpath.middlename, checkwithlength, "enter length");
            // WebElement number = driver.findElement(By.xpath("//span[@style='color:
            // rgb(185, 37, 0);']"));
            ...
            Utils.callSendkeys(driver, ActionXpath.middlename, checkwithSpecialCharacteronly,
                    "enter middle specialchar");
            // WebElement SpecialCharacteronly =
            // driver.findElement(By.xpath("//span[@style='color: rgb(185, 37, 0);']"));
            // String checkmiddlenamewithSpecialCharacteronly =
            // SpecialCharacteronly.getText();
    ...
    public static void testValidateEmail(String url, WebDriver Driver, String[] csvCell) throws Exception {
        try {
            ...
            Utils.callSendkeys(driver, ActionXpath.email, validemail, "enter invalidemail");

            Utils.cleartext(driver, ActionXpath.email);
            Utils.callSendkeys(driver, ActionXpath.email, invalidEmail1, "enter invalidemail");
            ...
            Utils.cleartext(driver, ActionXpath.email);
            Utils.callSendkeys(driver, ActionXpath.email, invalidEmail2, "enter invalidemail");
            // WebElement invalidmail2 = driver.findElement(By.xpath("//span[@style='color:
            // rgb(185, 37, 0);']"));
            ...
            Utils.cleartext(driver, ActionXpath.email);
            Utils.callSendkeys(driver, ActionXpath.email, invalidEmail3, "enter invalidemail");
            // WebElement invalidmail3 = driver.findElement(By.xpath("//span[@style='color:
            // rgb(185, 37, 0);']"));
            ...
            // }
            Utils.cleartext(driver, ActionXpath.email);
            Utils.callSendkeys(driver, ActionXpath.email, invalidEmail4, "enter invalidemail");
            // WebElement invlaidmail4 = driver.findElement(By.xpath("//span[@style='color:
            // rgb(185, 37, 0);']"));
    ...
    public static void testValidatephonenumber(String url, WebDriver Driver, String[] csvCell) throws Exception {
        try {
            ...
            Utils.callSendkeys(driver, ActionXpath.mobile, phonenumbervalid10digit, "enter pno");

            Utils.cleartext(driver, ActionXpath.mobile);
            Utils.callSendkeys(driver, ActionXpath.mobile, phonenumberdigitcheck, "enter pno");
            ...
            Utils.cleartext(driver, ActionXpath.mobile);
            Utils.callSendkeys(driver, ActionXpath.mobile, phonenumberalphabetcheck, "enter pno");
            ...
            Utils.cleartext(driver, ActionXpath.mobile);
            Utils.callSendkeys(driver, ActionXpath.mobile, phonenumberchecklength, "enter pno");
    ...
    public static void testValidateadditionalphonenumber(String url, WebDriver Driver, String[] csvCell)
        ...
        try {
            ...
            Utils.callSendkeys(driver, ActionXpath.mobilePhone, phonenumbervalid10digit, " additional no");

            Utils.cleartext(driver, ActionXpath.mobilePhone);
            Utils.callSendkeys(driver, ActionXpath.mobilePhone, phonenumberdigitcheck, "enter mob");
            WebElement phonenocheck = driver.findElement(By.xpath("//span[@style='color: rgb(185, 37, 0);']"));
            String checkphonedigit = phonenocheck.getText();
            System.out.println(checkphonedigit);
            ...
            Utils.cleartext(driver, ActionXpath.mobilePhone);
            Utils.callSendkeys(driver, ActionXpath.mobilePhone, phonenumberalphabetcheck, "phone no");
            WebElement phonenoalpha = driver.findElement(By.xpath("//span[@style='color: rgb(185, 37, 0);']"));
            String checkphonenumberalphabet = phonenoalpha.getText();
            System.out.println(checkphonenumberalphabet);
...

    {
        try {
            ...
            log.info("Tc10:-Salesforce Application view and verification passed");
            System.out.println("Tc15:-Salesforce Application view and verification testcase passed");
        } catch (Exception e) {
            e.printStackTrace();
            log.info("Tc10:-Salesforce Application view and verification failed");
            System.out.println("Tc10:-Salesforce Application view and verification testcase failed");
...

    {
        try {
            ...
            Utils.profile_logout(sal_url, driver, csvCell);
            log.info("Tc11:-Salesforce Application view and delete testcase passed");
            System.out.println("Tc11:-Salesforce Application view and delete testcase passed");
        } catch (Exception e) {
            e.printStackTrace();
            log.info("Tc11:-Salesforce Application view and delete testcase failed");
            System.out.println("Tc11:-Salesforce Application view and delete testcase failed");
...

    {
        try {
            ...
            log.info("Tc12:-Application with invalidnumber testcase passed");
            System.out.println("Tc12:-Application with invalidnumber testcase passed");
        } catch (Exception e) {
            e.printStackTrace();

            log.info("Tc12:-Application with invalidnumber testcase failed");
            System.out.println("Tc12:-Application with invalidnumber testcase failed");
        }
    }
...

    {
        try {
            ...
            log.info("Tc13:-Application form_fill and file_size check testcase and application delete passed");
            System.out
                    .println("Tc13:-Application form_fill and file_size check testcase and application delete passed");
        } catch (Exception e) {
            e.printStackTrace();

            log.info("Tc13:-Application form_fill and file_size check testcase and application delete failed");
            System.out
                    .println("Tc13:-Application form_fill and file_size check testcase and application delete failed");
        }
    }
...

    {
        try {
            ...
            log.info("Tc14:-Salesforce login,view,mark and delete testcase passed");
            System.out.println("Tc13:-Salesforce login,view,mark and delete testcase passed");
        } catch (Exception e) {
            e.printStackTrace();
            log.info("Tc14:-Salesforce login,view,mark and delete testcase Failed");
            System.out.println("Tc14:-Salesforce login,view,mark and delete testcase Failed");
        }
    }
    ...
    public static void validatewithfnfillform_W2l(String url, WebDriver Driver, String[] csvCell)
        ...
        try {
            ...
            log.info("Tc15:-firstname validate with complete form fill web2Lead  testcase Passed");
            System.out.println("Tc15:-firstname validate with complete form fill web2Lead  testcase Passed");
        } catch (Exception e) {
            e.printStackTrace();

            log.info("Tc15:-firstname validate with complete form fill web2Lead  testcase Failed");
            System.out.println("Tc15:-firstname validate with complete form fill web2Lead  testcase Failed");
        }
    }
