...
public class Utils {
	...
	public static void basic_info(WebDriver driver, String[] csvCell, String url) throws Throwable {
		...
		// Thread.sleep(4000);
		Utils.callSendkeys(driver, exp, dob, exp);
		...
		Utils.callSendkeys(driver, ActionXpath.lastName, lastname, "enter lastname");
		...
		if (checkToskipdob(url)) {
			...
			Utils.callSendkeys(driver, ActionXpath.dob, dob, "enter dob");
		}
		...
		if (checkToskipcourse(url)) {
			...
			Utils.clickXpath(driver, ActionXpath.qualif, time, "qualif");
	...
	public static void firstbasic_info(WebDriver driver, String[] csvCell, String url) throws Throwable {
		...
		if (checkmiddlename(url)) {
			...
			Utils.callSendkeys(driver, ActionXpath.middlename, middlename, "enter mname ");
		}

		Utils.callSendkeys(driver, ActionXpath.lastName, lastname, "enter lastname ");
		Utils.callSendkeys(driver, ActionXpath.email, email, "enter email");
		Utils.callSendkeys(driver, ActionXpath.mobile, mobile, "enter mobile");

		if (checkadditionalphone(url)) {
			System.out.println("no additional name");
		} else {
			Utils.callSendkeys(driver, ActionXpath.mobilePhone, mobilephone, "enter ");
		}
		...
		if (checkToskipcourse(url)) {
			...
			Utils.callSendkeys(driver, ActionXpath.aadhar, aadhar, "enter adhar");

			Utils.callSendkeys(driver, ActionXpath.enquiry, exp, "enter exp ");
	...
	public static void other_info(WebDriver driver, String[] csvCell, String url) throws Throwable {
...

		{
			...
			Utils.clickXpath(driver, ActionXpath.clickonreligion, time, "click on religion");
...

	{
		...
		try {
			...
			if (csvCell[69].equals("Bmjalnagar")) {
				Utils.clickXpath(driver, ActionXpath.registration, time, "click on registration");
			}

			String regex = "Null";
			String mobile = csvCell[68];
			Utils.callSendkeys(driver, ActionXpath.addphone, mobile, "enter mobileno ");
			Utils.clickXpath(driver, ActionXpath.getotp, time, "Request OTP");
			Thread.sleep(5000);
			Alert alert = driver.switchTo().alert(); // switch to alert
			String alertMessage = driver.switchTo().alert().getText(); // capture alert message
			System.out.println(alertMessage); // Print Alert Message
			Pattern pt = Pattern.compile("-?\\d+");
			java.util.regex.Matcher m = pt.matcher(alertMessage);
			while (m.find()) {
				regex = m.group();
			}
			// Thread.sleep(2000);
			alert.accept();
			Utils.callSendkeys(driver, ActionXpath.enterotp, regex, "enter otp ");

			Utils.clickXpath(driver, ActionXpath.clickongo, time, "clickongo");
			System.out.println(
	...
	public static void Appbasic_info(String app_url, WebDriver driver, String[] csvCell) throws Throwable {
		...
		if (csvCell[68].equals("Bmjalnagar")) {
			smallSleepBetweenClicks(1);

			Utils.clickXpath(driver, ActionXpath.apply, time, "apply");
			smallSleepBetweenClicks(1);
			Utils.clickXpath(driver, ActionXpath.clickongo1, time, " clickongo1");
			smallSleepBetweenClicks(1);
			Utils.clickXpath(driver, ActionXpath.clickonyes1, time, " clickonyes1");

		}

		else {
			smallSleepBetweenClicks(1);
			Utils.clickXpath(driver, ActionXpath.clickonnewapplication, time, "clickonnewapplication");
			smallSleepBetweenClicks(1);
			...
			Utils.clickXpath(driver, ActionXpath.clickonyes, time, "clickonyes");
		...
		WebElement eee = driver.findElement(By.xpath("(//button[@name='gender'])[3]"));
	...
	public static void family_info(String app_url, WebDriver driver, String[] csvCell) throws Exception {
		...
		Utils.clickXpath(driver, ActionXpath.clickonmaritalstatus, time, "clickonmaritalstatus");
		Thread.sleep(2000);
		...
		Utils.callSendkeys(driver, ActionXpath.bankholder, "suri", "enter bankholder");
		Utils.callSendkeys(driver, ActionXpath.bankname, "sbi", "enter bankname");
		Utils.callSendkeys(driver, ActionXpath.branchname, "bangaluru", "enter branchname ");
...

	{
		...
		Utils.callSendkeys(driver, ActionXpath.address, address, "enter address");
		...
		Utils.clickXpath(driver, ActionXpath.selectstate, time, "clickonstate1");
	...
	public static void salesforce_login(String sal_url, WebDriver driver, String[] csvCell) throws Exception {
		...
		Utils.callSendkeys(driver, ActionXpath.password, password, "enter password");
	...
	public static void clickonApplicationandselect(String sal_url, WebDriver driver, String[] csvCell)
		...
		// // WebDriverWait wait = new WebDriverWait(driver, 20);
		// WebElement e1 =
		// wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[.='All'])[1]")));
		// ((JavascriptExecutor) driver).executeScript("arguments[0].click();", e1);
		//
		...
		// slds-button_icon-border slds-button_icon-x-small'])[1]")));
		// ((JavascriptExecutor) driver).executeScript("arguments[0].click();", e11);
		...
		//
		// WebElement elem =
		// wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//lightning-button-menu[@class=\"slds-dropdown-trigger
		// slds-dropdown-trigger_click\"])[2]")));
		// ((JavascriptExecutor)driver).executeScript("arguments[0].click();", elem);
		// //driver.findElement(By.xpath("(//*[name()='svg' and @class='slds-icon
		// slds-icon-text-default slds-icon_xx-small'])[54]")).click();
	...
	public static void clickonApplicationview(String sal_url, WebDriver driver, String[] csvCell) throws Exception {
		...
		// && p.contains("Date Of Birth") && p.contains("Present Occupation") &&
		// p.contains("Gender")){
		...
		// String compareHolder = (String) jsExecutor.executeScript("return
		// arguments[0].value", webElement);
		//
		...
		driver.quit();
		// Thread.sleep(2000);
		// WebElement actual =driver.findElement(By.xpath("//input[@name='Date Of
		// Birth']"));
		...
		// Thread.sleep(2000);
		// WebElement expected =driver.findElement(By.xpath("//input[@name='Date Of
		// Birth']"));
	...
	public static void w2lform_validationcheck(WebDriver driver, String[] csvCell, String url) throws Throwable {
		...
		Utils.callSendkeys(driver, ActionXpath.firstname, firstnamevalidate, "enter fname validate");
		...
		Utils.callSendkeys(driver, ActionXpath.lastName, lastnamevalidate, "enter lastaname validate");
		...
		Utils.callSendkeys(driver, ActionXpath.email, emailvalidate, "enter emailvalidate");
		...
		Utils.callSendkeys(driver, ActionXpath.mobile, mobilevalidate, "enter mobility");
		...
		// log.info(" firstname and lastname should contain only alphabets with 40
		// character. email should contain 1 @special charcter with one uppercase ,phone
		// number should contain only 10 digit number should not contain alphanumeric
		// than PASSED \n\n");
		// } else {
		// log.warning(" firstname and lastname should contain only alphabets with 40
		// character. email should contain 1 @special charcter with one uppercase ,phone
		// number should contain only 10 digit number should not contain alphanumeric if
		// it doesn't contain than Failed\n");
		// }
	...
	public static void firstname_validationalphabet(WebDriver driver, String[] csvCell, String url) throws Throwable {
		String firstnamevalidate = csvCell[43];
		Utils.callSendkeys(driver, ActionXpath.firstname, firstnamevalidate, "enter firstname validate");
		WebElement fi = driver.findElement(
				By.xpath("(//p[@class='MuiTypography-root jss21 MuiTypography-body1 MuiTypography-alignLeft'])[1]"));
		String firstname = fi.getText();
		System.out.println(
	...
	public static void validateAppbasic_info(String app_url, WebDriver driver, String[] csvCell) throws Throwable {
		...
		Utils.clickXpath(driver, ActionXpath.clickonapply, time, "clickonapply");

		Utils.clickXpath(driver, ActionXpath.clickonyes, time, "clickonyes");
		Utils.cleartext(driver, ActionXpath.firstname);
		// Thread.sleep(2000);
		Utils.callSendkeys(driver, ActionXpath.firstname, firstname, "enter fathername");
		// Thread.sleep(1000);
		Utils.cleartext(driver, ActionXpath.surename);
		// Thread.sleep(1000);
		Utils.callSendkeys(driver, ActionXpath.surename, surename, "enter surename");
		// Thread.sleep(1000);
		Utils.cleartext(driver, ActionXpath.enterfathername);
		// Thread.sleep(2000);
		Utils.callSendkeys(driver, ActionXpath.enterfathername, fathername, "enter fathername");
		...
		Utils.cleartext(driver, ActionXpath.enterdob);
		// Thread.sleep(2000);
		Utils.callSendkeys(driver, ActionXpath.enterdob, dob, "enter mdob");
		// Thread.sleep(2000);
		Utils.cleartext(driver, ActionXpath.presentoccupation);
		// Thread.sleep(2000);
		Utils.callSendkeys(driver, ActionXpath.presentoccupation, occupation, "enter occupation");
		...
		Utils.cleartext(driver, ActionXpath.entermothername);
		// Thread.sleep(2000);
		Utils.callSendkeys(driver, ActionXpath.entermothername, mothername, "enter mothername");
		// Thread.sleep(2000);
		Utils.cleartext(driver, ActionXpath.enterguardianname);
		// Thread.sleep(2000);
		Utils.callSendkeys(driver, ActionXpath.enterguardianname, guardianname, "enter guardian");
